    ...
    var methods = {
      ...
      init: function () {
        return this.each(function (k) {
          ...
          else if ($this.hasClass('dantri-widget--live-exchange')) {
            subPath = '/interviews';
            type = 'interview';
          }
          else if ($this.hasClass('dantri-widget--report')) {
            subPath = '/reports';
            type = 'report';
          }
          ...
          var iframeUrl = window.location.protocol + '//' + domain + subPath + (id ? '/' + id : '') + '?embed=true';
          var iframeId = 'dantri-widget-' + type + '-' + id;
          $iframe = $('<iframe />')
            .attr({
              frameborder: 0,
              src: iframeUrl,
